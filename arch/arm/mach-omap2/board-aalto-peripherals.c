/* Peripherals code for Samsung YP-GS1
...
/* aalto LEDs support */
static struct platform_device aalto_led_device = {
	.name = "aaltoLedDriver",
	.id = -1,
};

/* aalto has only Volume UP/DOWN */
...
static struct twl4030_keypad_data aalto_kp_twl4030_data = {
...
static struct twl4030_power_data aalto_t2scripts_data = {
	.scripts = twl4030_scripts,
	.num = ARRAY_SIZE(twl4030_scripts),
	.resource_config = twl4030_rconfig,
};

static struct regulator_consumer_supply aalto_vmmc1_supply = {
	.supply		= "vmmc",
};

static struct regulator_consumer_supply aalto_vmmc2_supply = {
	.supply		= "vmmc",
};

static struct regulator_consumer_supply aalto_vmmc3_supply = {
	.supply		= "vmmc",
	.dev_name	= "omap_hsmmc.2",
};

static struct regulator_consumer_supply aalto_vaux3_supply = {
	.supply = "vaux3",
};

static struct regulator_consumer_supply aalto_vaux4_supply = {
	.supply = "vaux4",
};


/* VMMC1 for OMAP VDD_MMC1 (i/o) and MMC1 card */
static struct regulator_init_data aalto_vmmc1 = {
	.constraints = {
		.min_uV			= 1850000,
		.max_uV			= 3150000,
	...
	.consumer_supplies      = &aalto_vmmc1_supply,
};

/* VMMC2 for MMC2 card */
static struct regulator_init_data aalto_vmmc2 = {
	.constraints = {
		.min_uV			= 1850000,
		.max_uV			= 1850000,
		.apply_uV		= true,
	...
	.num_consumer_supplies  = 1,
	.consumer_supplies      = &aalto_vmmc2_supply,
};

static struct regulator_init_data aalto_vmmc3 = {
	.constraints = {
		.valid_ops_mask	= REGULATOR_CHANGE_STATUS,
	},
	.num_consumer_supplies	= 1,
	.consumer_supplies = &aalto_vmmc3_supply,
};

static struct fixed_voltage_config aalto_vwlan = {
	.supply_name		= "vwl1271",
	...
	.enable_high		= 1,
	.enabled_at_boot	= 0,
	.init_data		= &aalto_vmmc3,
};

static struct platform_device *aalto_board_devices[] __initdata = {
	&headset_switch_device,
	&board_zeus_key_device,     /* ZEUS KEY */ 
	&aalto_led_device,         /* SAMSUNG LEDs */ 
};
...
static struct regulator_consumer_supply aalto_vpll2_supplies[] = {
	REGULATOR_SUPPLY("vdds_dsi", "omapdss"),
	REGULATOR_SUPPLY("vdds_dsi", "omapdss_dsi1"),
};

/* VAUX3 for LCD */
static struct regulator_init_data aalto_aux3 = {
	.constraints = {
			.min_uV = 1800000,
			.max_uV = 1800000,
			.boot_on = true,
	...
	.num_consumer_supplies = 1,
	.consumer_supplies = &aalto_vaux3_supply,
};

/* VAUX4 for LCD */
static struct regulator_init_data aalto_aux4 = {
	.constraints = {
			.min_uV = 2800000,
			.max_uV = 2800000,
			.boot_on = true,
	...
	.num_consumer_supplies = 1,
	.consumer_supplies = &aalto_vaux4_supply,
};

static struct regulator_consumer_supply aalto_vdda_dac_supply =
	REGULATOR_SUPPLY("vdda_dac", "omapdss_venc");

static struct regulator_init_data aalto_vpll2 = {
	.constraints = {
		.min_uV                 = 1800000,
		.max_uV                 = 1800000,
		.valid_modes_mask       = REGULATOR_MODE_NORMAL
	...
	.num_consumer_supplies		= ARRAY_SIZE(aalto_vpll2_supplies),
	.consumer_supplies		= aalto_vpll2_supplies,
};

static struct regulator_init_data aalto_vdac = {
	.constraints = {
		.min_uV                 = 1800000,
		.max_uV                 = 1800000,
		.valid_modes_mask       = REGULATOR_MODE_NORMAL
	...
	.num_consumer_supplies		= 1,
	.consumer_supplies		= &aalto_vdda_dac_supply,
};

static int aalto_twl_gpio_setup(struct device *dev,
		unsigned gpio, unsigned ngpio)
{
	...
	*/
	aalto_vmmc1_supply.dev = mmc[1].dev;
	aalto_vmmc2_supply.dev = mmc[0].dev;

	return 0;
}

static int aalto_batt_table[] = {
/* 0 C*/
...
static struct twl4030_bci_platform_data aalto_bci_data = {
	.battery_tmp_tbl	= aalto_batt_table,
	.tblsize		= ARRAY_SIZE(aalto_batt_table),
};

static struct twl4030_usb_data aalto_usb_data = {
	.usb_mode	= T2_USB_MODE_ULPI,
};

static struct omap_musb_board_data aalto_musb_board_data = {
...
static struct twl4030_gpio_platform_data aalto_gpio_data = {
	.gpio_base	= OMAP_MAX_GPIO_LINES,
	.irq_base	= TWL4030_GPIO_IRQ_BASE,
	.irq_end	= TWL4030_GPIO_IRQ_END,
	.setup		= aalto_twl_gpio_setup,
	.debounce	= 0x04,
};

static struct twl4030_madc_platform_data aalto_madc_data = {
	.irq_line	= 1,
};

static struct twl4030_codec_audio_data aalto_audio_data;

static struct twl4030_codec_data aalto_codec_data = {
	.audio_mclk = 26000000,
	.audio = &aalto_audio_data,
};

static struct twl4030_platform_data aalto_twldata = {
	.irq_base	= TWL4030_IRQ_BASE,
	.irq_end	= TWL4030_IRQ_END,

	/* platform_data for children goes here */
	.bci		= &aalto_bci_data,
	.madc		= &aalto_madc_data,
	.usb		= &aalto_usb_data,
	.gpio		= &aalto_gpio_data,
	.keypad		= &aalto_kp_twl4030_data,
	.power		= &aalto_t2scripts_data,
	.codec		= &aalto_codec_data,
	.vmmc1          = &aalto_vmmc1,
	.vmmc2          = &aalto_vmmc2,
	.vaux3          = &aalto_aux3,
	.vaux4          = &aalto_aux4,
...
static int aalto_mxt_key_codes[MXT_KEYARRAY_MAX_KEYS] = {
	[0] = KEY_MENU,
	[1] = KEY_BACK,
};

/* aalto specific TSP configuration */
...
static struct mxt_platform_data aalto_mxt_platform_data = {
	...
	.key_codes	= aalto_mxt_key_codes,
	.tsp_en_gpio	= OMAP_GPIO_TOUCH_EN,
};

static struct i2c_board_info __initdata aalto_i2c_bus2_info[] = {
...
static struct i2c_board_info __initdata aalto_i2c_bus3_info[] = {
	{
		I2C_BOARD_INFO("atmel_mxt_ts", 0x4A),
		.platform_data = &aalto_mxt_platform_data,
		.irq = OMAP_GPIO_IRQ(OMAP_GPIO_TOUCH_INT),
	},
};

static struct i2c_gpio_platform_data aalto_gpio_i2c4_pdata = {
...
static struct platform_device aalto_gpio_i2c4_device = {
	.name	= "i2c-gpio",
	.id	= 4,
	.dev = {
		.platform_data = &aalto_gpio_i2c4_pdata,
	},
};

static __initdata struct i2c_board_info aalto_i2c5_boardinfo[] = {
	{
		I2C_BOARD_INFO("YamahaBMA222", 0x08),
	},
};

static struct i2c_gpio_platform_data aalto_gpio_i2c5_pdata = {
...
static struct platform_device aalto_gpio_i2c5_device = {
	.name	= "i2c-gpio",
	.id	= 5,
	.dev = {
		.platform_data = &aalto_gpio_i2c5_pdata,
	},
};

static __initdata struct i2c_board_info aalto_i2c6_boardinfo[] = {
	{
		I2C_BOARD_INFO("Si4709_driver", 0x10),
	},
};

static struct i2c_gpio_platform_data aalto_gpio_i2c6_pdata = {
...
static struct platform_device aalto_gpio_i2c6_device = {
	.name	= "i2c-gpio",
	.id	= 6,
	.dev = {
		.platform_data = &aalto_gpio_i2c6_pdata,
	},
};

static struct platform_device *aalto_i2c_gpio_devices[] __initdata = {
	&aalto_gpio_i2c4_device, // Fuel Guage MAX17040
	&aalto_gpio_i2c5_device, // Yamaha BMA222
	&aalto_gpio_i2c6_device, // Si4709 FM Radio
};
...
static int __init omap_i2c_init(void)
{
	...
	omap_register_i2c_bus(2, 400, aalto_i2c_bus2_info,
			ARRAY_SIZE(aalto_i2c_bus2_info));
	omap_pmic_init(1, 400, "twl5030", INT_34XX_SYS_NIRQ, &aalto_twldata);	
	omap_register_i2c_bus(3, 400, aalto_i2c_bus3_info,
			ARRAY_SIZE(aalto_i2c_bus3_info));

	i2c_register_board_info(5, aalto_i2c5_boardinfo, ARRAY_SIZE(aalto_i2c5_boardinfo));
	i2c_register_board_info(6, aalto_i2c6_boardinfo, ARRAY_SIZE(aalto_i2c6_boardinfo));
...
static inline void __init aalto_serial_init(void)
{
...
void __init aalto_peripherals_init(void)
{
	platform_add_devices(aalto_board_devices,
		ARRAY_SIZE(aalto_board_devices));
	aalto_power_init();
	aalto_connector_init();
	platform_add_devices(aalto_i2c_gpio_devices,
		ARRAY_SIZE(aalto_i2c_gpio_devices));
	atmel_dev_init();
	omap_i2c_init();
	platform_device_register(&omap_vwlan_device);
	usb_musb_init(&aalto_musb_board_data);
